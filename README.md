...
to the left of that, there is a number and text that says 'localhost' change 'localhost' to a LAN IP (if don't know how to get an address go to [short tutorial](https://uca.edu/it/knowledgebase-legacy/finding-your-ip-address-lan/#:~:text=Windows%207-,In%20the%20system%20tray%2C%20click%20the%20network%20connection%20icon%20and,appear%20in%20the%20format%20161.31.)) remember to keep the (') its very important
